...
<section class="hero-section">
    ...
    <div class="hero-slider owl-carousel">
        ...
        <div class="hs-item set-bg" data-setbg="../template/img/bg-2.jpg"
             style="background-repeat: no-repeat; background-size: cover; background-position: center 100%;">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-7 text-white">
                        <span>Новая коллекция</span>
            ...
            <?php foreach ($sliderProducts as $product): ?>
                <div class="product-item">
                    <div class="pi-pic">
                        ...
                        <div class="pi-links">
                            <a href="#" class="add-card add-to-cart" data-id="<?php echo $product['id']; ?>"><i
...
<section class="contact-section" id="contact">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 contact-info">
                ...
                <form class="contact-form" action="../controllers/emailController.php" id="form" method="post"
                      name="form">
    ...
    <div class="map">
		...
		sru!4v1555446222269!5m2!1sru!2sru" style="border:0" allowfullscreen></iframe>
    </div>
    <div>&nbsp</div>
</section>
<!-- Contact section end -->
